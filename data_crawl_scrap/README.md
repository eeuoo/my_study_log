![1](https://user-images.githubusercontent.com/44750085/51168870-cbfa3900-18ed-11e9-8844-eebbec1a5226.png)
...
## 본인이 정한 사이트를 크롤하여 데이터 수집을 하는 프로그램의 수집 계획서 및 코드를 작성하기.
```
<데이터 수집 계획>
